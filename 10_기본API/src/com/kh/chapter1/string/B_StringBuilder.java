...
public class B_StringBuilder {
	...
	public void method1() {
		...
		System.out.println("sb1의 버퍼의 길이 : " + sb1.capacity()); // 버퍼의 크기 (기본 값 : 16)
		System.out.println();
	...
	public void method2() {
		...
		String str = "안녕하세요.";
		StringBuilder sb = new StringBuilder("안녕하세요."); // 데이터 타입이 다르기 때문에 new 연산자 사용
		...
		str += "저는 황수영 입니다. ";
		sb.append("저는 황수영 입니다. ");
		
		System.out.println("str : " + str);
		System.out.println("sb : " + sb);
		System.out.println("sb의 문자열 길이 : " + sb.length());
		System.out.println("sb의 버퍼의 길이 : " + sb.capacity());
		System.out.println(System.identityHashCode(str));
		System.out.println(System.identityHashCode(sb));
		System.out.println();
		...
		// insert(int offset, String str) 메소드는 문자열의 offset 위치부터 전달받은 문자열을 추가한다.
		sb.insert(6, " ㅋㅋㅋㅋ ");
		System.out.println("sb : " + sb);
		System.out.println("sb의 문자열 길이 : " + sb.length());
		System.out.println("sb의 버퍼의 길이 : " + sb.capacity());
		...
		// 3. delete(int start, int end) 메소드는 start 에서 end-1 까지 인덱스에 해당하는 문자열을 삭제한다.
		sb.delete(2, 5);
		System.out.println("sb : " + sb);
		System.out.println("sb의 문자열 길이 : " + sb.length());
		System.out.println("sb의 버퍼의 길이 : " + sb.capacity());
