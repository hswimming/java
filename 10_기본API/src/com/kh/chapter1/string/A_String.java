...
public class A_String {
	public void method1() {
		...
		System.out.println(str1.toString()); // 객체의 정보를 리턴
		...
		System.out.println(str1.hashCode()); // 식별할 수 있는 정수값
		...
		// equals() 메소드
		System.out.println(str1.equals(str2)); // 주소값이 달라도 같은 데이터를 가지면 같은 값을 출력 하도록 리턴
		System.out.println(str1.equals(str4));
		System.out.println(str3.equals(str4));
	}	
	
	public void method2() {
		// String 클래에서 제공하는 메소드 사용
...
//		String str3 = str + "!!!!!!!!!!";
		...
		// 3. substring(int) 메소드는 매개값으로 전달된 위치에서 끝까지의 문자열을 새로 생성해서 리턴한다.
		...
		// 4. indexOf() 메소드는 전달받은 문자열의 시작 인덱스를 리턴한다. (주어진 문자열이 포함되어 있지 않으면 -1 리턴)
...
//		int index = str.lastIndexOf("World");
		...
		// 5. replace(char oldChar, chat newChar) 메소드는 문자열에서 oldChar를 newChar 문자로 변경된 새로운 문자열을 생성해서 리턴한다.
...
//		String str10 = String.valueOf(array);
	...
	public void method3() {
		...
		//	  split(String) 메소드는 입력받은 구분자로 문자열을분리해서 문자열의 배열로 담아서 리턴한다.
