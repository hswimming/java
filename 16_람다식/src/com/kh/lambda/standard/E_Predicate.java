...
public class E_Predicate {
	...
	public void method1() {
		Student student1 = new Student("황수영", 27, "여자", 80, 70); 
		Student student2 = new Student("보리", 10, "여자", 100, 100);
...
//		};
		...
		Predicate<Student> predicate = student -> student.getGender().equals("여자");
		
		System.out.println("황수영은 여자입니까? : " + predicate.test(student1));
		System.out.println("보리는 여자입니까? : " + predicate.test(student2));
		
//		BiPredicate<Student, Student> biPredicate = (Student s1, Student s2) -> {
//			
//			return s1.getGender().equals(student2.getGender());
//		};
		
		BiPredicate<Student, Student> biPredicate = (s1, s2) -> s1.getGender().equals(student2.getGender());
