...
public class B_Casting {
	...
	public void autoCasting() {
		...
		double d = l;
		// float 이 long 보다 표현 가능한 수의 범위가 더 크기 때문에 자동 형 변환이 가능하다.
...
//		int sum = (int) (i + d); // 4.0 + 4.123456789123456789 = 8.123456789123456789
...
//		double average = (double) total / 3; // 방법1
//		double average = total / 3.0; // 방법2 (196.0 / 3.0 = 65.333333)
...
//		System.out.printf("평균 : %.2f\n", average); // 소수점 두자리 까지만 출력
		...
		System.out.println("총점 : " + (language + english + math) + "점");
		System.out.println("평균 : " + ((double)(language + english + math)/3) + "점");
	}
}
