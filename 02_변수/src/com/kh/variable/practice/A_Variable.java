...
//		char ch = -90; // 에러 발생, 0 ~ 65,535 (유니코드 범위)
		char ch = 90;
...
//		String name = "황수영"; // new 생략하고 사용가능, 차이점은 있음
		String name = new String("황수영");
...
//		bNum = 128; // 에러 발생 => 범위 초과
		bNum = 11;
		sNum = 12;
		iNum = 300;
//		정수형 리터럴은 기본적으로 int 로 컴파일 된다.
//		long 타입 리터럴은 숫자 뒤에 L 또는 l 을 입력해야 한다.
//		lNum = 92233; // 범위 안에 있으면 상관없음
		lNum = 9223372036854L;
...
//		4) 예약어 사용 불가 (특정 역할, 이미 정해진 키워드이기 때문에 에러 발생)
//		int public;
//		int void;
//		int int;
//		int class;
	...
	public void constant() {
		 ...
		 * 		final 자료형 변수명;
		 * 
		 * 		- 변하지 않는 값으로 특정 변수의 값이 변경되는 걸 원하지 않을때 사용한다.
