...
public class A_HashSet {
	...
	public void method1() {
		...
		Set<String> set = new HashSet<>(); // 중복 저장 X
		 ...
		 * 	- String 클래스에는 hsahCode(), equals() 메소드가 오버라이딩 되어있다.
		...
		// 	- 가져올 인스턴스가 있는지 확인 할 때는 hasNext() 메소드를 사용한다.
		// 	- 하나의 인스턴스를 가져 올 때는 next() 메소드를 사용한다.
	...
	public void method2() {
		...
		set.add(new Music("시간의 지평선", "윤하", 1));
