 ...
 * 			...
 * 
 * 			2. 생성자 정의 (필드를 초기화 하거나, 객체를 사용할 준비를 한다.)
 * 			[접근 제한자] 클래스명([매개변수, ...]) {
 * 			... 실행 코드 ...
 * 			동일한 이름의 생성자가 여러개 올 수 있으나, 매개변수의 이름, 순서, 개수는 달라야함
 * 			}
 * 			...
 * 
 * 			3. 매소드 정의
...
//		this.phone = phone; // 참조변수
	...
	public void whoAreYou() {
		...
		System.out.printf("저는 %s의 %s를 가지고 있습니다.", phone.getBrand(), phone.getName());
	}
