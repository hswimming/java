...
//		System.out.println(fieldTest.privateField);
		...
		System.out.println("===================="); // B_StaticField 출력
		
//		3. 클래스 변수 테스트
		//클래스 변수는 프로그램 실행과 동시에 메모리(Stack)에 생성되었기 때문에 객체를 생성하지 않아도 클래스명으로 접근이 가능하다.
...
//		
//		System.out.println(staticField1.number); // 참조변수로 접근하고 있기 때문에 노란줄 뜸 (클래스명으로 바꾸는걸 지향함)
...
//		System.out.println(staticField2.number);
		...
		// 4. 상수 테스트
//		Math.PI = 3,11443333; // 불가능
		System.out.println(Math.PI);
		System.out.println(new C_StaticFinalField().MAX_LEVEL);
